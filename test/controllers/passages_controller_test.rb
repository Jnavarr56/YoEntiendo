...
class PassagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passage" do
    assert_difference('Passage.count') do
      post passages_url, params: { passage: { content: @passage.content, title: @passage.title, user_id: @passage.user_id } }
    end
  ...
  test "should update passage" do
    patch passage_url(@passage), params: { passage: { content: @passage.content, title: @passage.title, user_id: @passage.user_id } }
